...
### B570 kernel v4 (único perfil)

On Intel Xe2 / B570 the **v4** profile is always on (no version toggle / no v2–v3 fallback).  
See `docs/B570-Kernel-v4.md` · bench: `scripts/arc/bench-b570-kernel-v4.ps1`
